...
class FollowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follow" do
    assert_difference('Follow.count') do
      post follows_url, params: { follow: { follower_id: @follow.follower_id, status: @follow.status, user_id: @follow.user_id } }
    end
  ...
  test "should update follow" do
    patch follow_url(@follow), params: { follow: { follower_id: @follow.follower_id, status: @follow.status, user_id: @follow.user_id } }
